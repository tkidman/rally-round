...
const points = {
  ...
  overall: [
    50, 44, 40, 37, 34, 31, 28, 25, 23, 21, 19, 17, 15, 13, 11, 10, 9, 8, 7, 6,
  ...
  divisions: {
    jrc1: {
      ...
      wrc: [
        {
          clubId: "158",
          championshipIds: ["q1XaakXNRo32pCzw"],
    ...
    jrc2: {
      ...
      wrc: [
        {
          clubId: "26",
          championshipIds: ["BVezVbJWxTQHh6v5"],
          includeNextChampionships: true
        }
      ],
      events: [],
    ...
    jrc3: {
      ...
      wrc: [
        {
          clubId: "27",
          championshipIds: ["44W9Y9kLHpUE1TpkR"],
          includeNextChampionships: true
        }
      ],
      events: [],
      points,
      cars: ["Citroën C2 R2 Max", "Opel Adam R2", "Renault Twingo II"],
      manualResults: []
      // promotionRelegation: {
      //   // promotionDoubleZone: -,
      //   promotionZone: 24
